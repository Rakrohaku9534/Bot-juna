...
browser: ['Fahrul Multi Device','Safari','1.0.0'],
auth: state
})
...
pathFile = await writeExif(media, { packname: options.packname ? options.packname : 'F.A Bot', author: options.author ? options.author : '+6285786539008', categories: options.categories ? options.categories : [] })
